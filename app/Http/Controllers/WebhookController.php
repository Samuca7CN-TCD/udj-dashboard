...
class WebhookController extends Controller
{
    ...
    public function webhookDMGTransacoes(Request $request){
        ...
        if($request->api_token == $api_token){
            ...
            $dmg_t->trackings_source = $request->trackings['source'];
            $dmg_t->trackings_checkout_source = $request->trackings['checkout_source'];
            $dmg_t->trackings_utm_source = $request->trackings['utm_source'];
            $dmg_t->trackings_utm_campaign = $request->trackings['utm_campaign'];
            $dmg_t->trackings_utm_medium = $request->trackings['utm_medium'];
            $dmg_t->trackings_utm_content = $request->trackings['utm_content'];
            $dmg_t->trackings_utm_term = $request->trackings['utm_term'];
            $dmg_t->trackings_pptc = $request->trackings['pptc'];
